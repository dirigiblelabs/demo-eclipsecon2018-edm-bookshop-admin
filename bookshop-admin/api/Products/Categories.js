...
var dao = require('bookshop-admin/data/dao/Products/Categories');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/bookshop-admin/api/Categories.js/' + entity.Id);
