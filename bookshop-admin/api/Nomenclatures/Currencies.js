...
var dao = require('bookshop-admin/data/dao/Nomenclatures/Currencies');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/bookshop-admin/api/Currencies.js/' + entity.Id);
