...
var dao = require('bookshop-admin/data/dao/Stores/Stores');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Stores not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/bookshop-admin/api/Stores.js/' + entity.Id);
